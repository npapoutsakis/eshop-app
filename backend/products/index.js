...
app.get("/api/products", checkToken, async (request, response) => {
  try {
    const db = await pool;
...
app.get("/api/products/:param", checkToken, async (request, response) => {
  try {
...
app.post("/api/products", checkToken, async (request, response) => {
...
app.put("/api/products/:id", checkToken, async (request, response) => {
...
app.delete("/api/products/:id", checkToken, async (request, response) => {
  try {
    const id = request.params.id;
    const db = await pool;
